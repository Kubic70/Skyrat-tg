/mob/living/carbon/human/can_equip(obj/item/I, slot, disable_warning = FALSE, bypass_equip_delay_self = FALSE, invMouseOver)
	return dna.species.can_equip(I, slot, disable_warning, src, bypass_equip_delay_self, invMouseOver)
